                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('update.portfolio')}}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10 mb-3">
                                    <textarea id="elm1" name="portfolio_description" class="form-control">{{ $portfolio->portfolio_description}}</textarea>
                                </div>
                                ...
                                <div class="col-sm-10 mb- mt-3">
                                    <img id="showImage" class="rounded avatar-lg" src="{{(empty($portfolio->portfolio_image))? url('upload/home_slide/no_image.jpg'): url($portfolio->portfolio_image) }}" alt="Card image cap">
                                </div>
                            </div>
                            <input type="submit" value="Edit Portfolio" class="btn btn-info waves-effect waves-light">
                        </form>
                    </div>
                </div>
            </div> <!-- end col -->
